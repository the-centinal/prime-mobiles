...
class Ecommerce_Hub_About_Widget extends WP_Widget {
	function __construct() {
		parent::__construct(
			'Ecommerce_Hub_About_Widget',
			__('TG: About us', 'ecommerce-hub'),
			array( 'description' => __( 'Widget for about us section in sidebar', 'ecommerce-hub' ), ) 
		);
	}
	...
	public function widget( $args, $instance ) {
		...
		<div class="widget">
	        ...
	        <div class="social-links my-2">
		        <?php if(!empty($facebook_url) ){ ?><a class="custom_facebook fff" href=" <?php echo esc_url($instance['facebook_url']); ?>"><i class="fab fa-facebook-f p-2"></i><span class="screen-reader-text"><?php esc_html_e('Facebook','ecommerce-hub'); ?></span></a><?php } ?>
		        <?php if(!empty($twitter_url) ){ ?><a class="custom_twitter" href="<?php echo esc_url($instance['twitter_url']); ?>"><i class="fab fa-twitter p-2"></i><span class="screen-reader-text"><?php esc_html_e('Twitter','ecommerce-hub'); ?></span></a><?php } ?>
		        <?php if(!empty($linkedin_url) ){ ?><a class="custom_linkedin" href="<?php echo esc_url($instance['linkedin_url']); ?>"><i class="fab fa-linkedin-in p-2"></i><span class="screen-reader-text"><?php esc_html_e('Linkedin','ecommerce-hub'); ?></span></a><?php } ?>
		        <?php if(!empty($instagram_url) ){ ?><a class="custom_instagram" href="<?php echo esc_url($instance['instagram_url']); ?>"><i class="fab fa-instagram p-2"></i><span class="screen-reader-text"><?php esc_html_e('Instagram','ecommerce-hub'); ?></span></a><?php } ?>
		        <?php if(!empty($pinterest_url) ){ ?><a class="custom_instagram" href="<?php echo esc_url($instance['pinterest_url']); ?>"><i class="fab fa-pinterest-p p-2"></i><span class="screen-reader-text"><?php esc_html_e('Pinterest','ecommerce-hub'); ?></span></a><?php } ?>
		    </div>
	...
	public function form( $instance ) {
    	...
    	<p>
	        <label for="<?php echo esc_attr($this->get_field_id('author')); ?>"><?php esc_html_e('Author Name:','ecommerce-hub'); ?></label>
    	...
    	<p>
	        <label for="<?php echo esc_attr($this->get_field_id('designation')); ?>"><?php esc_html_e('Designation:','ecommerce-hub'); ?></label>
    	...
    	<p>
	        <label for="<?php echo esc_attr($this->get_field_id('description')); ?>"><?php esc_html_e('Description:','ecommerce-hub'); ?></label>
    	...
    	<p>
			<label for="<?php echo esc_attr($this->get_field_id('facebook_url')); ?>"><?php esc_html_e('Facebook URL:','ecommerce-hub'); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('twitter_url')); ?>"><?php esc_html_e('Twitter URL:','ecommerce-hub'); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('linkedin_url')); ?>"><?php esc_html_e('Linkedin URL:','ecommerce-hub'); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('instagram_url')); ?>"><?php esc_html_e('Instagram URL:','ecommerce-hub'); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('pinterest_url')); ?>"><?php esc_html_e('Pinterest URL:','ecommerce-hub'); ?></label>
    	...
    	<p>
			<label for="<?php echo esc_attr($this->get_field_id('read_more_text')); ?>"><?php esc_html_e('Button Text:','ecommerce-hub'); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('read_more_url')); ?>"><?php esc_html_e('Button Url:','ecommerce-hub'); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'upload_image' )); ?>"><?php esc_html_e( 'Image Url:','ecommerce-hub'); ?></label>
			<?php
				if ( $upload_image != '' ) :
...
function ecommerce_hub_about_custom_load_widget() {
	register_widget( 'Ecommerce_Hub_About_Widget' );
}
add_action( 'widgets_init', 'ecommerce_hub_about_custom_load_widget' );