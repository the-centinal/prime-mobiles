...
class Ecommerce_Hub_Icon_Selector extends WP_Customize_Control{
      public $type = 'icon';
            ...
            <label>
                  ...
                  <ul class="icon-list">
                      <div class="social-icon-search">
                          <input class="socialInput" type="text" placeholder="<?php echo esc_attr('Search Icon', 'ecommerce-hub'); ?>">
                      </div>
                    <?php
                    $ecommerce_hub_font_awesome_icon_array = ecommerce_hub_font_awesome_icon_array();
                    foreach ($ecommerce_hub_font_awesome_icon_array as $ecommerce_hub_font_awesome_icon) {
                            $icon_class = $this->value() == $ecommerce_hub_font_awesome_icon ? 'icon-active' : '';
                            echo '<li class='.esc_attr($icon_class).'><i class="'.esc_attr($ecommerce_hub_font_awesome_icon).'"></i>
                            <span class="ecommerce-hub-social-class">'.esc_attr($ecommerce_hub_font_awesome_icon).'</span>
                            </li>';
                        }
                    ?>
                  </ul>
...
function ecommerce_hub_customizer_script() {
     
    wp_enqueue_style( 'font-awesome-1', esc_url(get_template_directory_uri()).'/css/fontawesome-all.css');
}
add_action( 'customize_controls_enqueue_scripts', 'ecommerce_hub_customizer_script' );

if(!function_exists('ecommerce_hub_font_awesome_icon_array')){
    function ecommerce_hub_font_awesome_icon_array(){
